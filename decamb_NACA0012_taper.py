# Lift distribution for various alfas of a tapered NACA0012 wing wtih the decambering model
...
sections = [
    ...
    VLM.Section(fy_pos=1.0, fc=0.1, x_offset=0.0, z_offset=0.0, twist_deg=0.0, airfoil_path_str="Assets/naca0012.dat", xfoil_path_str="Assets/NACA0012_XFOIL.out")
]
...
fig.set_figwidth(10)
fig.set_figheight(6)
fig.savefig("Images/Clsec_naca0012_taper_decamb.png")
plt.show()
