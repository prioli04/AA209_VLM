...
sections = [
    ...
    VLM.Section(fy_pos=0.5, fc=0.75 ,x_offset=0.03, twist_deg=0.0, airfoil_path_str="S1223.dat"),
    VLM.Section(fy_pos=1.0, fc=0.5, x_offset=0.1, twist_deg=0.0, airfoil_path_str="naca0012.dat")
]

patches = [
    VLM.WingPatch(10, 5, DiscretizationType.COSINE, DiscretizationType.UNIFORM),
    VLM.WingPatch(10, 8, DiscretizationType.COSINE, DiscretizationType.MINUS_SINE)
]
