...
sections = [
    ...
    VLM.Section(fy_pos=1.0, fc=1.0, x_offset=0.0, z_offset=0.3, twist_deg=0.0, airfoil_path_str="naca0012.dat", xfoil_path_str="NACA0012_XFOIL.OUT")
]

patches = [
    VLM.WingPatch(4, 16, DiscretizationType.UNIFORM, DiscretizationType.UNIFORM),
